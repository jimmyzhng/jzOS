...
const Window = () => {
    return (
        // Main Window
        <div className="flex flex-col w-128 h-96 rounded-t-lg overflow-hidden border-l-[3px] border-r-[3px] border-b-[3px] border-[#003edb] shadow-xl font-sans">

            {/* Title Bar */}
            <div className="flex h-8 bg-gradient-to-b from-[#0058e6] via-[#3a93ff] to-[#003edb] flex justify-between items-center px-1">
                {/* Title Text */}
